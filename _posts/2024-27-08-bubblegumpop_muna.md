...
@import url('https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Audiowide&family=Black+Ops+One&family=Blaka+Hollow&family=Bungee+Shade&family=Comfortaa:wght@300;400;500;600;700&family=Creepster&family=Eater&family=Ewert&family=Fontdiner+Swanky&family=Freckle+Face&family=Fredoka+One&family=Hanalei&family=Luckiest+Guy&family=Monoton&family=Moo+Lah+Lah&family=Press+Start+2P&family=Ranchers&family=Rubik+Beastly&family=Rubik+Dirt&family=Rubik+Glitch&family=Rubik+Moonrocks&family=Warnes&display=swap');@import "rouge-base16-dark";
...
font-family: 'Fontdiner Swanky','Luckiest Guy', cursive;
...
h1, h2, h3, h4, h5, h6 {
      ...
      text-shadow:
          ...
          0 0 125px #0DCBFF;
      margin: 0 0 20px;
  /* margin: 1.03em; */  padding: 5px;
  background: linear-gradient(135deg, #1f005c, #2c005d, #47005f, #680060, #8b0460, #ac265e, #c9475c, #df675c, #ef855e, #f89e63, #fdaf69, #ffb56b);  
}
li {
  line-height: 1.4 ;
}
